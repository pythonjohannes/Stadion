...
class Johannes(db.Model):
    ...
    instämplad_timme = db.Column(db.Integer, nullable=True, default=0000)
    instämplad_minut = db.Column(db.Integer, nullable=True, default=0000)
    ...
    utstämplad_timme = db.Column(db.Integer, nullable=True, default=0000)
    utstämplad_minut = db.Column(db.Integer, nullable=True, default=0000)
